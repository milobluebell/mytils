...
const Home: FunctionalComponent = () => {
  return (
    <div>
      ...
      <Demo params={[0.24242645, (Math.random() * 2).toFixed(0), true]} method={getRatioFromNum}></Demo>
      <Demo params={['23.3452%', (Math.random() * 2).toFixed(0), false]} method={getNumFromRatio}></Demo>
    </div>
  );
};
